...
<div id="main">
 ...
 <div id="content" class="site-content"> 
 	<div class="item-top5-issue">
 	  <p style="float:left"><img src="images/12_shopping_03.gif" width="78" height="35"></p> 
      <div class="txtpink14 font-gentfont" style="padding-top:17px; float:left; padding-left:5px">Product of </div>
       <div class="title-category font-gentfont" style="padding-top:5px; float:left; padding-left:5px">Decoration 
       <a href="item.php?item_category_id=3&sub_category_id=1" class="txtpink14">View all  &nbsp; <img src="images/bullet-view.gif" width="11" height="12"></a>
       </div>
      <p class="clear"></p>
      <div class="item-top5-issue-left">
         ...
         <?php
				$qrySelTop1 = "select item_image,item_title ,item_id,item_like,item_comment
							...
							where item_publish != '0' and item_category_id_FK = '3' and item_sub_category_id_FK = '1'
							order by item_id desc, item_like desc limit 0,1 ";	
				//echo $qrySel1;
    ...
    <div  class="content-item"  style="margin-top:0">
       ...
       <?php
          $qrySelBanner = "select banner_url,banner_name,banner_swf,banner_pic,banner_id
                              ...
                              where publish != '0' and bannerCategoryID_FK = '10'
                              order by rand()";	
    ...
    <div class="content-item"> 
      ...
      <div><span class="txtpink14 font-gentfont">Product of </span> <span class="title-category">Home </span> &nbsp; &nbsp; <span class="txtpink14"><a href="item.php?item_category_id=3&sub_category_id=2">View all  &nbsp; <img src="images/bullet-view.gif" width="11" height="12"></a></span></div>
        <ul class="bxslider-item">
         <?php
				$qrySel1 = "select item_image_thumb,item_title ,item_id,item_like,item_comment
							from $_Config_table[item] 
							where item_publish != '0' and item_category_id_FK = '3'  and item_sub_category_id_FK = '2'
    ...
    <div class="content-item"> 
      <div class="content-side-left">
      <div><span class="title-category">From Audience</span> &nbsp; &nbsp; <span class="txtpink14"><a href="item.php?item_category_id=4&item_sub_category_id=5">View all  &nbsp; <img src="images/bullet-view.gif" width="11" height="12"></a></span></div>
        <ul class="bxslider-item">
         <?php
				$qrySel1 = "select item_image_thumb,item_title ,item_id,item_like,item_comment
							from $_Config_table[item] 
							where item_publish != '0' and item_category_id_FK = '4' and item_sub_category_id_FK ='5'
      ...
      <div class="content-side-right">
        <p style="text-align:right"><a href="#"><img src="images/sponsored-item.gif" width="85" height="18"class="hoverImg09"></a></p>
         ...
         <?php
            $qrySelBanner = "select banner_url,banner_name,banner_swf,banner_pic,banner_id
								 from $_Config_table[banner]  
								where publish != '0' and bannerCategoryID_FK = '4' and banner_id != '$rowPicBanner[banner_id]'
								order by rand()";	
			$rsSelPicBanner = $DB->Execute($qrySelBanner);	 
			$rowPicBanner = $rsSelPicBanner->FetchRow();
		 ?>
