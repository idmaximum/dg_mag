...
<head>
<meta charset="utf-8">
<title>How To<?php echo $_Config_sitename?></title>
...
<div id="main">
 ...
 <div id="content" class="site-content"> 
    ...
    <div class="content-item"> 
      <div class="content-side-left">
      <div><span class="title-category">From Audience</span> &nbsp; &nbsp; <span class="txtpink14"><a href="item.php?item_category_id=5&item_sub_category_id=4">View all  &nbsp; <img src="images/bullet-view.gif" width="11" height="12"></a></span></div>
        <ul class="bxslider-item">
         <?php
				$qrySel1 = "select item_image_thumb,item_title ,item_id,item_like,item_comment
							from $_Config_table[item] 
