...
<head>
<meta charset="utf-8">
<title>Kitchen <?php echo $_Config_sitename?></title>
<meta name="description" content="<?php echo $_Config_description?>">
<meta name="keywords" content="Kitchen, <?php echo $_Config_keyword?>">
...
<div id="main">
 ...
 <div id="content" class="site-content"> 
 	<div class="item-top5-issue">
 	  <p style="float:left"><img src="images/icon_kitchen.gif" width="87" height="35"></p>
    ...
    <div  class="content-item"  style="margin-top:0">
       ...
       <?php
          $qrySelBanner = "select banner_url,banner_name,banner_swf,banner_pic,banner_id
                              ...
                              where publish != '0' and bannerCategoryID_FK = '5'
                              order by rand()";	
    ...
    <div class="content-item"> 
      ...
      <div><span class="title-category">Another on Back Issue </span> &nbsp; &nbsp; <span class="txtpink14"><a href="item.php?item_category_id=2">View all  &nbsp; <img src="images/bullet-view.gif" width="11" height="12"></a></span></div>
    ...
    <div class="content-item"> 
      <div class="content-side-left">
      <div><span class="title-category">From Audience</span> &nbsp; &nbsp; <span class="txtpink14"><a href="item.php?item_category_id=4&item_sub_category_id=4">View all  &nbsp; <img src="images/bullet-view.gif" width="11" height="12"></a></span></div>
        <ul class="bxslider-item">
         <?php
				$qrySel1 = "select item_image_thumb,item_title ,item_id,item_like,item_comment
							from $_Config_table[item] 
							where item_publish != '0' and item_category_id_FK = '4' and item_sub_category_id_FK ='4'
